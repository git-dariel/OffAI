...
class TensorFlowService {
  ...
  private static responses: { [key: string]: { text: string; image?: string } } = {
    ...
    bossing: { text: "kumusta ang buhay buhay bossing? mukha ka paring burat bossing😝" },
    "bading ka": { text: "mas bading ka tanga, mukha ka pang burat" },
    bading: { text: "mas bading ka tanga, mukha ka pang burat" },
    bakla: { text: "mas bakla ka tanga, mukha ka pang burat" },
    iyakin: { text: "ikaw nga yung iyakin diyan, pangit mo" },
    nigga: { text: "anong nigga? kupal ka pala eh" },
    galit: { text: "di ako galit tanga ka pala eh" },
